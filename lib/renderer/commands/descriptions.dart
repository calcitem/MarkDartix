...
class CommandDescriptions {
  static const Map<String, String> _commandDescriptions = {
    ...
    'mt.hide': 'MarkDartix: Hide MarkDartix',
    'mt.hide-others': 'MarkDartix: Hide Others',
...
// #
    ...
    'file.check-update': 'MarkDartix: Check for Updates...',
    ...
    'docs.user-guide': 'MarkDartix: End User Guide',
    'docs.markdown-syntax': 'MarkDartix: Markdown Syntax Guide'
  };

  static String getDescription(String id) {
    return _commandDescriptions[id] ?? '';
  }
}
