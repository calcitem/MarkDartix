...
const commands = [
...

  {
    ...
    id: 'docs.user-guide',
    execute: async () => {
      shell.openExternal('https://github.com/calcitem/markdartix/blob/master/docs/README.md')
    }
  }, {
    id: 'docs.markdown-syntax',
    execute: async () => {
      shell.openExternal('https://github.com/calcitem/markdartix/blob/master/docs/MARKDOWN_SYNTAX.md')
    }
  },
