<template>
  <div class="pref-keybindings">
    ...
    <section class="keybindings">
      <div class="text">
        Customize MarkDartix shortcuts and click on the save button below to apply all changes (requires a restart).
...
export default {
  ...
  mounted () {
    ...
    this.showDebugTools = global.markdartix.env.debug
  },
  ...
  methods: {
    openKeybindingWiki () {
      shell.openExternal('https://github.com/calcitem/markdartix/blob/master/docs/KEYBINDINGS.md')
    },
    saveKeybindings () {
