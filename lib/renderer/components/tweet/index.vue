...
export default {
  ...
  methods: {
    ...
    reportViaGithub () {
      shell.openExternal('https://github.com/calcitem/markdartix/issues/new')
    },
    reportViaTwitter () {
      ...
      const params = {
        via: 'markdartixme',
        url: encodeURI('https://github.com/calcitem/markdartix/'),
        text: value
      }

      if (selectedFace === 'smile') params.hashtags = 'happyMarkDartix'
