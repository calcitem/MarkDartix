...
class Muya {
   ...
   * is currently used to replace a misspelled word in MarkDartix that was selected
   * by Chromium.
   *
   ...
   */
  _replaceCurrentWordInlineUnsafe (word, replacement) { // __MARKDARTIX_PATCH__
...
function getContainer (originContainer, options) {
  ...
  // a custom implementation like in MarkDartix.
